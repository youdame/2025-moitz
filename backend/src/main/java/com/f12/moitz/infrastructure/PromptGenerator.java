...
public class PromptGenerator {
    ...
    public static final String ADDITIONAL_WITH_CANDIDATE_PROMPT = """
            ...
            [중요 추천 조건]
            1. 추천 지하철역은 반드시 5개이어야합니다,
            2. 추천 지하철 역은 제공하는 후보지 목록 안에 있어야 합니다.
            2. 총 추천받는 지하철역은  3개의 추천 조건을 나눕니다.
            3. 지하철역 2개는 반드시 출발지 목록을 하나의 선으로 이었을때 선으로부터  거리가 3KM 이상 떨어진 지역을 추천받습니다.
            4. 지하철역 2개는 반드시 각 출발지에서 지하철로 이동했을 때 시간이 비슷한 지역을 추천받습니다.
            4. 지하철역 1개는 반드시 각 출발지를 선으로 이었을때 중간좌표를 부근 지역을 추천받습니다.
